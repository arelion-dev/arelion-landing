...
const CASE_STUDIES = [
  {
    ...
    hook: {
      en: "Search and chat over an enterprise document corpus, with a citation on every answer.",
      fr: "Recherche et chat sur un corpus documentaire d'entreprise, avec une citation sur chaque réponse.",
    },
  ...
  },
  {
    ...
    hook: {
      en: "All of a company's paperwork, sorted and searchable, with no cloud.",
      fr: "Toute la paperasse d'une entreprise, rangée et interrogeable, sans cloud.",
    },
  ...
  },
  {
    ...
    hook: {
      en: "An agent that cites its sources, never a law that doesn't exist.",
      fr: "Un agent qui cite ses sources, jamais une loi qui n'existe pas.",
    },
  ...
  },
  {
    ...
    hook: {
      en: "A realtime AI buyer, to practice without burning real prospects.",
      fr: "Un acheteur IA en temps réel, pour s'entraîner sans cramer de vrais prospects.",
    },
    tags: ["voice", "realtime"],
  ...
  },
  {
    ...
    hook: {
      en: "A coding assistant for devs on sensitive work, without a single line leaving the machine.",
      fr: "Un assistant de code pour des devs sur du sensible, sans qu'une ligne sorte de la machine.",
    },
  ...
  },
  {
    ...
    hook: {
      en: "Make an LLM agent reliable at the output, not in the prompt.",
      fr: "Fiabiliser un agent LLM à la sortie, pas dans le prompt.",
    },
  ...
  },
  {
    ...
    hook: {
      en: "AI-assisted KYC, with a human only on the doubtful cases.",
      fr: "KYC assisté par IA, avec un humain sur les seuls cas douteux.",
    },
    tags: ["KYC", "compliance"],
  ...
  },
  {
    ...
    hook: {
      en: "The holes a team coding with AI never sees coming.",
      fr: "Les failles qu'une équipe qui code avec l'IA ne voit pas venir.",
    },
    tags: ["sécurité", "audit"],
  ...
  },
  {
    ...
    hook: {
      en: "The backdoor you can't read inside a model.",
      fr: "La porte dérobée qu'on ne peut pas lire dans un modèle.",
    },
