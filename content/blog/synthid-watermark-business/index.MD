...
<!-- Below are the three states, one under the other: a plain answer, the watermarked one, and a paraphrase of it. Read them: same meaning each time. Only the detector score under each tells them apart. -->
